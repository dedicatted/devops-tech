...
func TestEKSAddons(t *testing.T) {
    ...
    oidc_provider_arn := terraform.Output(t, EksterraformOptions, "oidc_provider_arn")
    cluster_name := terraform.Output(t, EksterraformOptions, "cluster_name")
    eks_cluster_endpoint := terraform.Output(t, EksterraformOptions, "cluster_endpoint")
    eks_cluster_certificate := terraform.Output(t, EksterraformOptions, "cluster_certificate_authority_data")
